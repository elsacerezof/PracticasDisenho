...
namespace Pr_06_Observer
{
    ...
    public partial class SparrowElementViewerCtrl: UserControl
    {
        ...
        ///     visualizado.
        /// </summary>
        protected SistemaArchivo sparrowElement;

        /// <summary>
        ///     El elemento del sistema de archivos actualmente 
        ///     visualizado.
        /// </summary>
        public virtual SistemaArchivo SparrowElement
        {
            get
            {
        ...
        protected void displayElement()
        {
            if (this.sparrowElement != null) {
               this.lb_NameText.Text = this.sparrowElement.getName();
               this.lb_SizeText.Text = this.sparrowElement.contarTamanho().ToString();
            } else
            {
