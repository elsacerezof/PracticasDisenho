...
namespace Pr_06_Observer
{
    ...
    public partial class FileNameEditor : Form
    {
        ...
        protected IDictionary<String, IElto_Sistema_Archivos> elementos =
            new SortedDictionary<String, IElto_Sistema_Archivos>();
        ...
        public IElto_Sistema_Archivos SparrowFileSystem
        {
            set
            {
